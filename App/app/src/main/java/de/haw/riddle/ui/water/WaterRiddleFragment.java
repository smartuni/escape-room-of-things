...
public class WaterRiddleFragment extends DaggerFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        congrats.setOnClickListener(v -> {
            NavHostFragment.findNavController(this).navigate(R.id.action_fragmentRiddle1_to_congratulationsWindow, CongratulationsWindow.createArgs(R.id.action_congratulationsWindow_to_legoRiddleFragmentPart1));
