...
static ssize_t loadcell_handler(coap_pkt_t *pdu, uint8_t *buf, size_t len, void *ctx);
...
static const coap_resource_t _resources[] = {
    ...
    { "/load_cell", COAP_PUT | COAP_GET, loadcell_handler, NULL },
...
/* implementation of load cell handler */
static ssize_t loadcell_handler(coap_pkt_t *pdu, uint8_t *buf, size_t len, void *ctx)
{
